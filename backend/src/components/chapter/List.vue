...
export default {
    ...
    methods: {
        ...
        editRow(id) {
            this.$router.push({name:"章节修改", params: {id}})
        },
        add() {
            this.$router.push({name:"章节添加"})
        },
        list() {
           chapter.list({}).then((res) => {
        ...
        section(cource_id) {
            this.$router.push({name:"小节列表", params:{cid: cource_id}})
        }
    }
}
</script>
